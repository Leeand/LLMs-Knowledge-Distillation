...
CUDA_VISIBLE_DEVICES=0,1,2,3 python distill_training.py --teacher_model_config teacher_tune_log/$tune_ckpt_path/  --prune_model prune_log/$prune_ckpt_path/pytorch_model.bin --data_path yahma/alpaca-cleaned --output_dir tune_log/$tune_ckpt_path --wandb_project llama_tune --lora_r 8 --num_epochs 2 --learning_rate 1e-4 --batch_size 6
