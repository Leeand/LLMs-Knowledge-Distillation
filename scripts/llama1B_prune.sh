...
hyperparamaters_name='llama1B_middle_layer_k1_h1_t_DDP' # update the name according the hyperparamaters

# echo "[START] - Start Pruning Model"
# CUDA_VISIBLE_DEVICES=1 python hf_prune.py --base_model 'TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T' --pruning_ratio 0.25 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 20 --block_attention_layer_start 4 --block_attention_layer_end 20 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --test_after_train --taylor param_first --save_model
