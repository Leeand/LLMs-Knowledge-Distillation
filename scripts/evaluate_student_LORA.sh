...
base_model='ahxt/LiteLlama-460M-1T' # e.g., huggyllama/llama-7b
tune_ckpt_name="tune_log/llama1B_middle_layer_k1_h1_t_DDP/globalstep_1084"  # e.g., student_tune_log/llama_13000yahma_alpaca   tune_log/k1_h1_t1/globalstep_6500 tune_log/k1_h1_t4/globalstep_6500 tune_log/k1_h1_t8/globalstep_6500
prune_ckpt="prune_log/llama1B_prune" # e.g., prune_log/llama_prune
